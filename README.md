...
A sticky, always-on-top floating panel for your desktop that tracks GitHub PRs and issues with a clean dark UI, time-since-opened indicators, and lightning-fast navigation.

## Stack
- **Frontend:** React + TypeScript + Tailwind CSS v4
- **Backend:** Rust (Tauri v2)
- **Target:** macOS first (universal binary)
